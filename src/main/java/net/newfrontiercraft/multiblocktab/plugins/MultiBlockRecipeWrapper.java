...
import net.newfrontiercraft.multiblocktab.gui.InventoryBlockView;
import net.newfrontiercraft.multiblocktab.mixin.RecipesGuiAccessor;
import net.newfrontiercraft.multiblocktab.recipe.BlockPatternEntry;
